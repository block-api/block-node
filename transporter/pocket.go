...
func NewPocket[P PayloadDiscovery | PayloadMessage[any]](channel Channel, versionName types.NodeVersionName, fromID types.NodeID, targetID types.NodeID, payload P) Pocket[[]byte] {
